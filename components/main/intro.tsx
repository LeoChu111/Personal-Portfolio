...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        Highly motivated Junior Software Developer with qualifications in information technology and software engineering. 
        Passionate about front-end and back-end development, 
        I am proficient in a range of languages and frameworks.
        My ultimate goal is to evolve into a full stack developer, 
        leveraging my passion and drive to contribute effectively to tech industry.
      </motion.p>
      ...
      >
        ...
        <a 
          ...
          href="https://www.linkedin.com/in/wen-hao-chu/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/LeoChu111"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
